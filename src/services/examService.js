...
export default class ExamService extends Component {
  ...
  getExamsByTeacher(teacherId) {
    return axios.get(
      "http://localhost:8080/exam/getAllByTeacher?teacherId=" + teacherId
    );
  }

  getExamsByStudent(studentId) {
    return axios.get(
      "http://localhost:8080/exam/getAllByStudent?studentId=" + studentId
    );
  }
  getByExamId(examId) {
  ...
  getByLessonId(lessonId) {
    return axios.get(
      "http://localhost:8080/exam/getByLessonId?lessonId=" + lessonId
    );
  }

  getByActive(lessonId) {
    return axios.get(
      "http://localhost:8080/exam/getByActive?lessonId=" + lessonId
    );
  }
